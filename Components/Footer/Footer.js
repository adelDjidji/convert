...
export default function Footer() {
  return (
    <footer className="footer">
      <Row>
        <Col xs={24} sm={24} md={24} lg={6} xl={6}>
          <a href="/">
            <img
              className="icon"
              style={{ height: 30, marginTop: -15, marginLeft: -7 }}
        ...
        <Col xs={24} sm={24} md={24} lg={4} xl={4} className="only-desktop">
          <h3 className="white bold Montserrat f14">COMPANY</h3>
          <ul className="footer-list whi">
            <li>
              <a className="whi" href="/aboutus">
                About Convert
              </a>{" "}
            </li>
            <li>
              <a className="whi" href="/earningcalculator">
                Pricing
              </a>
            </li>
            <li>
              <a className="whi" href="/contact">
                Contact Us
              </a>
            </li>
          </ul>
        ...
        <Col xs={24} sm={24} md={24} lg={4} xl={4} className="only-desktop">
          <h3 className="white bold Montserrat f14">WHY CHOOSE US</h3>
          <ul className="footer-list whi">
            <li>
              <a className="whi" href="/membership">
                Membership Benefits
              </a>
            </li>
            <li>
            ...
            <li>
              <a className="whi" href="/freecredit">
                45 Days Credit Extension
              </a>
            </li>
            <li>
              <a className="whi" href="/freecredit#extra-cash">
                Extra Cash
              </a>
            </li>
          </ul>
        ...
        <Col xs={24} sm={24} md={24} lg={4} xl={4} className="only-desktop">
          ...
          <ul className="footer-list whi">
            <li>
              <a className="whi" href="/Instantbill">
                Store on Cloud
              </a>
            </li>
          </ul>
        ...
        <Col xs={24} sm={24} md={24} lg={4} xl={4} className="only-desktop">
          <h3 className="white bold Montserrat f14">LEGAL</h3>
          <ul className="footer-list whi">
            <li>
              <a className="whi" href="/terms">
                Terms & Conditions
              </a>
            </li>
            <li>
              <a className="whi" href="/privacy">
                Privacy Policy
              </a>
            </li>
            <li>
              <a className="whi" href="/fraudsecurity">
                Fraud & Security
              </a>
            </li>
            <li>
              <a className="whi" href="/contact#faq">
                FAQ
              </a>
            </li>
          </ul>
        </Col>
        <Col span={24} className="only-mobile">
          <Collapse
            ...
            expandIcon={({ isActive }) =>
              isActive ? (
                <img src="/Assets/icons/cheveron-up.png" alt="icon up"/>
              ) : (
                <img src="/Assets/icons/cheveron-down.png" alt="icon down"/>
              )
            }
          >
          <Panel
      ...
      <hr />
      <p className="whi center copy">
        Copyright© 2020 Pay N Earn Pte. Ltd All Rights Reserved
      </p>
    </footer>
  );
}
