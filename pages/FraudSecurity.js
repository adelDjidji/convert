...
export default function FraudSecurity({}) {
  return (
    ...
    <Head>
        <title>CONVERT | Fraud & Security</title>
      </Head>
      <NavBar mode="white" className="no-border" />
      <div className="header center">
        <h1 className="title">
          Pay safe with advanced protection & security from
          <img
            className="icon"
        ...
        <h3 className="sub-title red2">
          PAY WITH CONFIDENCE WITH OUR TWO-FACTOR-AUTHENTICATION (2FA) AND REAL
          TIME UPDATE ON YOUR TRANSACTION STATUS
        </h3>
      </div>
      <div className="page-container">
        <div className="bg1"></div>
        <section className="section1">
          <div className="boite-wraper">
            <div className="boite">
              <h1 className="title-section">
                A better & secured way to pay your car installment with{" "}
                <img
                  className="icon"
              ...
              <Row>
                <Col xs={24} sm={24} md={24} lg={14}>
                  <div className="item">
                    <div>
                      <img src="/Assets/icons/fraud-icon1.png" alt="" />
                    </div>
                    <div>
                      <h3 className="tit">Advanced Fraud Protection</h3>
                      <p className="simple">
                        Your payment is protected with Two-Factor-Authentication
                        (2FA). OTP.{" "}
                      </p>
                    </div>
                  </div>
                  <div className="item">
                    <div>
                      <img src="/Assets/icons/fraud-icon2.png" alt="" />
                    </div>
                    <div>
                      <h3 className="tit">Fortify your user account</h3>
                      <p className="simple width2">
                        Prevent hackers and malicious programs from gaining
                        access to your account with strong security detection
                        and firewall..
                      </p>
                    </div>
                  </div>
                  <div className="item">
                    <div>
                      <img src="/Assets/icons/fraud-icon3.png" alt="" />
                    </div>
                    <div>
                      <h3 className="tit">Protect against phishing</h3>
                      <p className="simple width2">
                        Prevent anyone who disguises themselves as trusted
                ...
                <Col xs={24} sm={24} md={24} lg={10}>
                  <div className="item">
                    <div>
                      <img
                        className="sm"
                        src="/Assets/icons/fraud-icon4.png"
                        alt=""
                      />
                    </div>
                    <div>
                      <h3 className="tit">Extra security layer</h3>
                      <p className="simple width2">
                  ...
                  <div className="item">
                    <div>
                      <img
                        className="md"
                        src="/Assets/icons/fraud-icon5.png"
                        alt=""
                      />
                    </div>
                    <div>
                      <h3 className="tit">One-time password</h3>
                      <p className="simple width2">
                        One-time password is only valid for 1 min for your
            ...
            <Row type="flex" justify="space-between" className="keepp">
              <Col xs={24} sm={24} md={24} lg={12}>
                <h1 className="keep">
                  We keep your account secured 24/7 fraud monitoring
                </h1>
              </Col>
              <Col xs={24} sm={24} md={24} lg={12} className="flex-end">
                <div>
                  <p className="red2">
                    Download <span className="blue">“CONVERT”</span> now{" "}
                  </p>
        ...
        <section className="section2">
          <div className="div1">
            <div>
              <h1 className="keep">Reporting a Problem </h1>
              <p className="simple max2">
                Our support team is available to help with any transaction
                problems via live chat and email.
              </p>
            </div>
          </div>
          <div className="div2">
            <Row>
              ...
              <Col xs={24} sm={24} md={24} lg={12}>
                <div className="f">
                  <h1 className="keep red">Review your account </h1>
                  <p className="simple white left">
                    If you identify an unathorized charge on your account,
                    investigate it and notify us right away. Make sure that the
                    charge wasn’t simply made by an authorized person or
                    employee without your knowledge.{" "}
                  </p>
                </div>
              </Col>
        ...
        <section className="section3">
          <h1 className="title-section center">How Can I Protect Myself?</h1>
          <Row type="flex">
            <Col xs={24} sm={24} md={24} lg={8}>
              <div className="card-item">
                <img src="/Assets/icons/fraud-icon2-1.png" alt="" />
                <h2 className="title">PROTECT YOUR PASSWORDS</h2>
                <p className="simple content">
                  This applies to all online accounts. Set a strong password and
                  change them from time to time. This can prevent fraudsters
                  from gaining access to you CarEarnz account or linked email
                  accounts, and helps prevent the ID theft.
                </p>
              </div>
            </Col>
            <Col xs={24} sm={24} md={24} lg={8}>
              <div className="card-item">
                <img src="/Assets/icons/fraud-icon2-2.png" alt="" />
                <h2 className="title">PROTECT YOUR PAYMENT </h2>
                <p className="simple content">
                  Your payment is protected by Two-Factor- Authentication (2FA),
                  with an OTP code sent to your device. It is not advisable for
                  you to share your OTP code with any third party, to prevent
                  from falling into phishing.
                </p>
              </div>
            </Col>
            <Col xs={24} sm={24} md={24} lg={8}>
              <div className="card-item">
                <img src="/Assets/icons/fraud-icon2-3.png" alt="" />
                <h2 className="title">CHECK YOUR TRANSACTION </h2>
                <p className="simple content">
                  As a best practice, check your transactions and statements
                  regularly to identify any unfamiliar transactions.
                </p>
              </div>
            </Col>
          </Row>
        ...
        <section className="section4">
          <Row type="flex" justify="space-around" align="middle">
            <Col xs={24} sm={24} md={24} lg={12}>
              <h1 className="keep">
                Chat with us about any concerns, suggestions, or disputed
                transactions.
              </h1>
            </Col>
            <Col xs={24} sm={24} md={24} lg={12} className="contact-section2">
              <h2 className="small-title white">Contact Us</h2>
